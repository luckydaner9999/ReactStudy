...
Ext.define('private_cooker.store.Store_Collect',{
    extend:'Ext.data.Store',
    requires:[
        'private_cooker.model.Model_Collect',
        'private_cooker.util.Tools'
    ],

    config:{
        model:'private_cooker.model.Model_Collect',
        autoLoad:true,
        autoDestroy:true,
        remoteFilter:true,
        ...
        proxy:{
            type:'jsonp',
            url:private_cooker.util.Tools.getDomain()+'/collect/sencha',
            reader:{
                type:'json'
            }},
        pageSize:2,
